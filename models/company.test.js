...
// All this functions are conected to the _testCommon.js, but I do not know how are related with the current file
...
describe("findAll", function () {
  ...
  test("works: on min employees", async function () {
  ...
  test("works: on max employees", async function () {
  ...
  test("works: on min & max employees", async function () {
  ...
  // Add test by the name
  test("works: on company name", async function () {
